...
в axw.class идёт подгрузка модов из папки C:\Xenoceal\mods   
в lG.class убираются проверки на доступ к внутренним классам майнкрафта   
pW.class это интерфейс класса lG.class, иначе без него не запускается майнкрафт
