...
в awC.class идёт подгрузка модов из папки C:\Xenoceal\mods   
в lk.class убираются проверки на доступ к внутренним классам майнкрафта   
fY.class это интерфейс класса lk.class, иначе без него не запускается майнкрафт
