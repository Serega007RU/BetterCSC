...
в awb.class идёт подгрузка модов из папки C:\Xenoceal\mods   
в od.class убираются проверки на доступ к внутренним классам майнкрафта   
rR.class это интерфейс класса od.class, иначе без него не запускается майнкрафт
