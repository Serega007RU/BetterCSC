...
в WZMnlZT.class идёт подгрузка модов из папки C:\Xenoceal\mods, также разрешена модификация пакетов для PluginMessage (убрано использование метода slice в ByteBuf)
в PJbUlbM.class убираются проверки на доступ к внутренним классам майнкрафта   
KOwIGyM.class это интерфейс класса PJbUlbM.class, иначе без него не запускается майнкрафт
